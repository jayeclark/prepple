        ...
        >
          ...
          <div className="action-options">
            <svg onClick={(e) => { e.stopPropagation(); setModalMode("archive"); setCurrentModalID(v.id); setShowModal(true) }} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#666" viewBox="0 0 16 16">
              ...
              &nbsp;
            <svg onClick={(e) => { e.stopPropagation(); setModalMode("delete"); setCurrentModalID(v.id); setCurrentS3Key(v.attributes.s3key || "1");  setShowModal(true) }}xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#666" viewBox="0 0 16 16">
